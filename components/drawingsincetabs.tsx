...
const TABS = [
  {
    label: "DRAWING SINCE",
    path: "/generator/states/new_york/megamillions/overview/drawingsince",
  },
  {
    label: "POSITION 01",
    path: "/generator/states/new_york/megamillions/overview/position1",
  },
  {
    label: "POSITION 02",
    path: "/generator/states/new_york/megamillions/overview/position2",
  },
  {
    label: "POSITION 03",
    path: "/generator/states/new_york/megamillions/overview/position3",
  },
  {
    label: "POSITION 04",
    path: "/generator/states/new_york/megamillions/overview/position4",
  },
  {
    label: "POSITION 05",
    path: "/generator/states/new_york/megamillions/overview/position5",
  },
  {
    label: "POSITION MB",
    path: "/generator/states/new_york/megamillions/overview/positionmb",
  },
];
