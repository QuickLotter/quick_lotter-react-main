  ...
  return [
    {
      ...
      bonusNumber: "10",
      powerPlay: "2x",
      result: "No Jackpot Winner | 1 Match 5 Winner | AR",
      config_ui: {
        borderColor: "#C7102E",
        borderWidth: 4,
        borderRadius: 22,
    ...
    },
    {
      ...
      config_ui: {
        ...
        borderRadius: 22,
        background: "#F6FCFF",
        gradient: ["#F6FCFF", "#26A9E1", "#F6FCFF"],
        ballGradient: ["#FFFFFF", "#BBBBBB"],
        ballTextColor: "#0099DC",
        lastBallGradient: ["#FFFFFF", "#BBBBBB"],
        lastBallTextColor: "#0099DC",
        playButtonColor: "#26A9E1",
        playButtonBorder: "#26A9E1",
        playButtonTextColor: "#fff",
        logoMarginBottom: 10,
      },
    },
    ...
    },
    {
      ...
      config_ui: {
        ...
        borderRadius: 22,
        background: "#F7FFFA",
        gradient: ["#F7FFFA", "#1F5EC6", "#F7FFFA"],
        ballGradient: ["#FFFFFF", "#BBBBBB"],
        ballTextColor: "#000",
        lastBallGradient: ["#FFFFFF", "#BBBBBB"],
        lastBallTextColor: "#000",
        playButtonColor: "#E42440",
        playButtonBorder: "#1F5EC6",
        playButtonTextColor: "#fff",
        logoMarginBottom: 10,
      },
    },
    {
      ...
      config_ui: {
        ...
        borderRadius: 22,
        background: "#FBFFF2",
        gradient: ["#FBFFF2", "#007934", "#FBFFF2"],
        ballGradient: ["#FFFFFF", "#BBBBBB"],
        ballTextColor: "#000",
        lastBallGradient: ["#FFFFFF", "#BBBBBB"],
        lastBallTextColor: "#000",
        playButtonColor: "#007934",
    ...
    },
    {
      ...
      config_ui: {
        ...
        borderRadius: 22,
        background: "#F7FAFF",
        gradient: ["#F7FAFF", "#4E83B2", "#F7FAFF"],
        ballGradient: ["#FFFFFF", "#BBBBBB"],
        ballTextColor: "#4E83B2",
        lastBallGradient: ["#FFFFFF", "#BBBBBB"],
        lastBallTextColor: "#4E83B2",
        playButtonColor: "#4E83B2",
        playButtonBorder: "#4E83B2",
        playButtonTextColor: "#fff",
        logoMarginBottom: 10,
      },
    },
