...
export default function Position4MegaMillions() {
  ...
  // Salvar e navegar para Position 05
  const handleSave = () => {
    if (selectedNumbers.length > 0) {
      router.push(
        `/overview/ny/megamillions/position5?selected1=${selected1}&selected2=${selected2}&selected3=${selected3}&selected4=${selectedNumbers.join(
          ","
        )}`
      );
    }
