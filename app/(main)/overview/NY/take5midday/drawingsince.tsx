...
const POSITION_HEADERS = {
  "DRAWING SINCE": Array.from({ length: 39 }, (_, i) => i + 1),
};
...
export default function DrawingSinceTake5Midday() {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      {/* HEADER PRINCIPAL */}
      <GameHeader
        logo={<Take5Logo width={100} height={40} />}
        title="Overview"
      ...
      <View style={styles.fixedHeader}>
        <View style={styles.filtersPad}>
          <View style={styles.datesRow}>
            <Text style={[styles.dateLabel, { color: "#00928F" }]}>From</Text>
            <TouchableOpacity
              style={styles.input}
            ...
            <Text style={[styles.dateLabel, { color: "#00928F" }]}>To</Text>
            <TouchableOpacity
              style={styles.input}
      ...
      <View style={styles.tableHeaderRow}>
        <View style={[styles.dateBoxHeader, { backgroundColor: "#00928F" }]}>
      ...
      <ScrollView style={{ flex: 1 }}>
        {filteredRows.map((row, rowIndex) => (
          <View key={rowIndex} style={styles.gridRow}>
            <View style={[styles.dateBoxGrid, { backgroundColor: "#00928F" }]}>
