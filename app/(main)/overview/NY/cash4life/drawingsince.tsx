...
// Tabs (adapte as rotas conforme seu projeto)
const TABS = [
  ...
  { label: "Position CB", route: "positioncb", color: "#3E4982" }, // MB amarelo
];
...
export default function DrawingSince() {
  ...
  // Centralizar tab ativa ao entrar/ao clicar
  ...
  // Scroll sincronizado header/grid/footer
      ...
      <View style={styles.tabsWrapper}>
        ...
        >
          {TABS.map((tab, idx) => {
            ...
            const isMB = tab.route === "positionmb";
            return (
              <TouchableOpacity
                key={tab.route}
