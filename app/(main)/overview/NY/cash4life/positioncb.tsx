...
// ======= Adicione o array de tabs do Powerball =======
const TABS = [
  ...
  { label: "Position CB", route: "positioncb", color: "#3E4982" }, // PB especial
];
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  isActive &&
                    (isPB
                      ? {
                          backgroundColor: "#2D7F67", //cor do fundo do botao PB
                          borderColor: "#3E4982", //cor da borda do fundo do botao PB
                        }
                      : {
