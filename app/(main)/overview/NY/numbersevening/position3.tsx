...
const POSITION_HEADERS = {
  "POSITION 03": [3, 1, 4, 2, 6, 0, 7, 8, 5, 9],
};
...
export default function Position3Win4Evening() {
  ...
  const handleSave = () => {
    if (selectedNumbers.length > 0) {
      router.push(
        `/overview/ny/win4evening/position4?selected1=${selected1}&selected2=${selected2}&selected3=${selectedNumbers.join(
          ","
        )}`
      );
    }
