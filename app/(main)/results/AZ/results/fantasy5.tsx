...
const allResults = Array.from({ length: 37 }).map((_, idx) => ({
  ...
  jackpot: "$56,000",
  numbers: [1, 7, 12, 30, 37], // Altere conforme necessário
}));
...
const styles = StyleSheet.create({
  ...
  whiteBall: {
    ...
    height: 40,
    borderRadius: 22,
    backgroundColor: "#92BE37", // Azul Numbers
    justifyContent: "center",
    alignItems: "center",
    marginHorizontal: 4,
  },
  ...
  loadMoreBtn: {
    ...
    borderRadius: 22,
    backgroundColor: "#2766A8",
    alignSelf: "center",
    shadowColor: "#2766A888",
    shadowOpacity: 0.09,
    shadowRadius: 6,
