...
// ✅ Logo do Cash 4 Life
import { default as Cash4LifeLogo } from "@/assets/images/ny_game_logo/cash4life.svg";
...
export default function Cash4LifeGeneratorPage() {
  ...
  const lines =
    mainNumbers.length >= 5 && extraNumbers.length >= 1
      ? Math.round(combinations(mainNumbers.length, 5) * extraNumbers.length)
      : 0;
  ...
  return (
    <View style={styles.wrapper}>
      <View style={[styles.header, { backgroundColor: ui.headerColor }]}>
        <GameHeader
          logo={<Cash4LifeLogo width={100} height={38} />}
          title="Generator"
        ...
        <View style={styles.sliderBar}>
          <GameSelectorSlider state="ny" currentGame="cash4life" />
        </View>
      </View>
        ...
        <View style={styles.centered}>
          ...
          {ui.totalExtraBalls > 0 && (
            <NumberGrid
              ...
              titleColor={ui.extraTitleColor} // ✅ Cor do título da extra ball
            />
          )}
