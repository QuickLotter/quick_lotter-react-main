...
// MOCK DATA (trocar pelo fetch da API/Supabase depois)
...
export default function AnalysisAdjacent() {
  // Datas selecionadas
  ...
  // MOCK rows/freq — trocar para resultado da API/Supabase depois
  ...
  // useEffect(() => {
  //   fetchAdjacentAnalysis(fromDate, toDate).then(({ rows, freq }) => {
  //     setRows(rows);
  //     setFreq(freq);
  //   });
  // }, [fromDate, toDate]);
    ...
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.fixedHeader}>
        <GameHeader
          ...
          title="Analysis"
          subtitle="California Mega Millions"
          headerColor="#0E4CA1"
          backTo="/analysis/CA/analysis"
        />
        ...
        <View style={styles.tableContent}>
          <View style={styles.tableRow}>
            ...
            <View style={styles.adjacentBoxGreen}>
              <Text style={styles.adjacentBoxGreenText}>ADJ</Text>
            </View>
        ...
        <View style={styles.tableContent}>
          {rows.map((row, i) => (
            <View key={i} style={styles.tableRow}>
              ...
              <View style={styles.adjacentBoxGreen}>
                <Text style={styles.adjacentBoxGreenText}>{row.adjacent}</Text>
              </View>
