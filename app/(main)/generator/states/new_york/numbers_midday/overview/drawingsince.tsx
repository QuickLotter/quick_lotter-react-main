// app/(main)/generator/states/new_york/numbers_midday/overview/drawingsince.tsx
...
import NumbersMiddayLogo from "@/assets/images/ny_game_logo/numbers_midday.svg"; // ajuste para numbers_evening se precisar
import DrawingSinceTabs from "@/components/drawingsincetabs";

// HEADER: 0 a 9 para Numbers (pode usar ["0", ... "9"] como no exemplo)
const POSITION_HEADERS = {
  "DRAWING SINCE": Array.from({ length: 10 }, (_, i) => `${i}`),
};

// MOCK DATA (troque depois pelo fetch real)
...
export default function DrawingSinceNumbersMidday() {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      {/* HEADER PRINCIPAL */}
      <GameHeader
        logo={<NumbersMiddayLogo width={100} height={40} />}
        title="Overview"
        subtitle="Numbers Midday"
        headerColor="#2E73B5"
      ...
      <View style={styles.fixedHeader}>
        <View style={styles.filtersPad}>
          <View style={styles.datesRow}>
            <Text style={[styles.dateLabel, { color: "#2E73B5" }]}>From</Text>
            <TouchableOpacity
              style={styles.input}
            ...
            <Text style={[styles.dateLabel, { color: "#2E73B5" }]}>To</Text>
            <TouchableOpacity
              style={styles.input}
      ...
      <ScrollView style={{ flex: 1 }}>
        {filteredRows.map((row, rowIndex) => (
          <View key={rowIndex} style={styles.gridRow}>
            <View style={[styles.dateBoxGrid, { backgroundColor: "#2E73B5" }]}>
