...
// Você pode alterar essa ordem conforme a análise real da POSITION 01 do Cash 4 Life
const POSITION_HEADERS = {
  "POSITION 01": [
    3, 1, 4, 2, 8, 10, 7, 6, 11, 5, 9, 15, 14, 12, 13, 16, 17, 20, 21, 18, 19,
    29, 23, 28, 27, 25, 34, 22, 24, 33, 26, 30, 36, 46, 39, 38, 32, 31, 56, 52,
    41, 40, 37, 35, 42, 43, 44, 45, 47, 48, 49, 50, 51, 53, 54, 55, 57, 58, 59,
    60,
  ],
};
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.fixedHeader}>
        <View style={styles.filtersPad}>
          <View style={styles.datesRow}>
            <Text style={[styles.dateLabel, { color: "#2D7F67" }]}>From</Text>
            <TouchableOpacity
              style={styles.input}
            ...
            <Text style={[styles.dateLabel, { color: "#2D7F67" }]}>To</Text>
            <TouchableOpacity
              style={styles.input}
      ...
      <View style={styles.tableHeaderRow}>
        <View style={[styles.dateBoxHeader, { backgroundColor: "#2D7F67" }]}>
      ...
      <ScrollView style={{ flex: 1 }}>
        {filteredRows.map((row, rowIndex) => (
          <View key={rowIndex} style={styles.gridRow}>
            <View style={[styles.dateBoxGrid, { backgroundColor: "#2D7F67" }]}>
