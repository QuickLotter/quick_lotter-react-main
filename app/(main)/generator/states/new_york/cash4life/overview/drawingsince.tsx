...
const POSITION_HEADERS = {
  "DRAWING SINCE": Array.from({ length: 60 }, (_, i) => i + 1),
  // Se precisar de outras posições depois, é só adicionar aqui
};
...
const FREQ_60 = Array.from(
  { length: 60 },
  () => Math.floor(Math.random() * 350) + 10
);

export default function DrawingSinceCash4Life() {
