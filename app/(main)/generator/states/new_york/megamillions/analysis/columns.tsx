...
const freqBoxes = [
  { value: 95, bgColor: "#43A047", textColor: "#000" }, //2
  { value: 50, bgColor: "#FFEB3B", textColor: "#000" }, //3
  { value: 49, bgColor: "#FB8C00", textColor: "#000" }, //4
...
const styles = StyleSheet.create({
  ...
  columnsBoxGreenText: {
    fontSize: 14,
    fontWeight: "bold",
    color: "#FFF", // ✅ letra branca dentro do bloco columns
  },
  headerText: {
    fontSize: 14,
    fontWeight: "600",
