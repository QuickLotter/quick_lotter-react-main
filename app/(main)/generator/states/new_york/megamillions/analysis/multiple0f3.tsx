...
export default function Analysismultiple0f3() {
  const [active, setActive] = useState("multiple0f3");
      ...
      <View style={styles.fixedHeader}>
        ...
        <View style={styles.tableContent}>
          <View style={styles.tableRow}>
            ...
            <View style={styles.multiple0f3BoxGreen}>
              <Text style={styles.multiple0f3BoxGreenText}>FIB</Text>
            </View>
        ...
        <View style={styles.tableContent}>
          {rows.map((row, i) => (
            <View key={i} style={styles.tableRow}>
              ...
              <View style={styles.multiple0f3BoxGreen}>
                <Text style={styles.multiple0f3BoxGreenText}>
                  {row.multiple0f3}
                </Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  multiple0f3BoxGreenText: {
    fontSize: 14,
    fontWeight: "bold",
    color: "#000", // ✅ letra branca dentro do bloco multiple0f3
  },
  headerText: {
    fontSize: 14,
    fontWeight: "600",
