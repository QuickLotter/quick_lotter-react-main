...
export default function AnalysisRepeated() {
  // Estados das datas do picker
  ...
  const rows = MOCK_ROWS; // Futuramente: trocar por dados da API
  ...
  // Exemplo de onde integrar API/Supabase:
  // useEffect(() => {
  //   fetchRepeatedAnalysis(fromDate, toDate).then(({ rows, freq }) => {
  //     setRows(rows);
  //     setFreq(freq);
  //   });
  // }, [fromDate, toDate]);
      ...
      <View style={styles.fixedHeader}>
        ...
        <View style={styles.tableContent}>
          <View style={styles.tableRow}>
            ...
            <View style={styles.repeatedBoxGreen}>
              <Text style={styles.repeatedBoxGreenText}>REP</Text>
            </View>
        ...
        <View style={styles.tableContent}>
          {rows.map((row, i) => (
            <View key={i} style={styles.tableRow}>
              ...
              <View style={styles.repeatedBoxGreen}>
                <Text style={styles.repeatedBoxGreenText}>{row.repeated}</Text>
              </View>
